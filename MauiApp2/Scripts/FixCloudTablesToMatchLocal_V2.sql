-- Fix Cloud Database Tables to Match Local Database Structure (V2 - Fixed)
...
BEGIN
    ...
    ELSE
    BEGIN
        PRINT '⚠ stock_in_date already exists in tbl_stock_in';
    END
    ...
    BEGIN
        ...
        IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbl_users]') AND type in (N'U'))
        BEGIN
            IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_stock_in_user')
            BEGIN
                ALTER TABLE [dbo].[tbl_stock_in]
    ...
    ELSE
    BEGIN
        PRINT '⚠ processed_by already exists in tbl_stock_in';
    END
END
ELSE
BEGIN
    PRINT '⚠ tbl_stock_in table does not exist';
END
GO
...
BEGIN
    ...
    ELSE
    BEGIN
        PRINT '⚠ quantity_rejected already exists in tbl_stock_in_items';
    END
    ...
    ELSE
    BEGIN
        PRINT '⚠ rejection_reason already exists in tbl_stock_in_items';
    END
    ...
    ELSE
    BEGIN
        PRINT '⚠ rejection_remarks already exists in tbl_stock_in_items';
    END
END
ELSE
BEGIN
    PRINT '⚠ tbl_stock_in_items table does not exist';
END
GO
...
BEGIN
    ...
    BEGIN
        ...
        IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbl_users]') AND type in (N'U'))
        BEGIN
            IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_sales_order_user')
            BEGIN
                ALTER TABLE [dbo].[tbl_sales_order]
...
ELSE
BEGIN
    PRINT '⚠ tbl_sales_order table does not exist';
END
GO
...
ELSE
BEGIN
    PRINT '⚠ tbl_sales_order_items table does not exist';
END
GO
...
BEGIN
    ...
    BEGIN
        ...
        IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbl_sales_order]') AND type in (N'U'))
        BEGIN
            IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_stock_out_sales_order')
            BEGIN
                ALTER TABLE [dbo].[tbl_stock_out]
    ...
    BEGIN
        ...
        IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbl_users]') AND type in (N'U'))
        BEGIN
            IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_stock_out_user')
            BEGIN
                ALTER TABLE [dbo].[tbl_stock_out]
...
ELSE
BEGIN
    PRINT '⚠ tbl_stock_out table does not exist';
END
GO
